...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" @class(['dark' => ($appearance ?? 'system') == 'dark'])>
    <head>
        ...
        <meta property="og:title" content="Agent1Call — Smart Call Tracking & Telefoniya">
        ...
        <meta property="twitter:title" content="Agent1Call — Smart Call Tracking & Telefoniya">
        ...
        <link rel="icon" href="/images/1call_logo.png" type="image/png">
        
        <link rel="apple-touch-icon" href="/images/1call_logo.png">
        ...
        <x-inertia::head>
            <title>{{ config('app.name', 'Agent1Call') }}</title>
        </x-inertia::head>
    </head>
